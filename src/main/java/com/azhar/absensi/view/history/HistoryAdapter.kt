...
class HistoryAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvNomor.text = data.uid.toString()
    ...
    inner class ViewHolder(val binding: ListHistoryAbsenBinding) : RecyclerView.ViewHolder(binding.root) {
        var tvStatusAbsen: TextView = binding.tvStatusAbsen
        var tvNomor: TextView = binding.tvNomor
        var tvNama: TextView = binding.tvNama
        var tvLokasi: TextView = binding.tvLokasi
        var tvAbsenTime: TextView = binding.tvAbsenTime
